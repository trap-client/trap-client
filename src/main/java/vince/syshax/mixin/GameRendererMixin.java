...
import vince.syshax.events.render.RenderAfterWorldEvent;
...
import vince.syshax.systems.modules.player.LiquidInteract;
import vince.syshax.systems.modules.player.NoMiningTrace;
...
import vince.syshax.systems.modules.render.Zoom;
import vince.syshax.systems.modules.world.HighwayBuilder;
import vince.syshax.utils.Utils;
import vince.syshax.utils.render.NametagUtils;
import vince.syshax.utils.render.RenderUtils;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorld(float tickDelta, long limitTime, MatrixStack matrices, CallbackInfo info, boolean bl, Camera camera, MatrixStack matrixStack, double d, float f, float g, Matrix4f matrix4f, Matrix3f matrix3f) {
        ...
        client.getProfiler().push(SYSHax.MOD_ID + "_render");
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        SYSHax.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }
