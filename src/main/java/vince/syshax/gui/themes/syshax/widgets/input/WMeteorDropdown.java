...
public class WMeteorDropdown<T> extends WDropdown<T> implements SYSHaxWidget {
    ...
    private static class WRoot extends WDropdownRoot implements SYSHaxWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            SYSHaxGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements SYSHaxWidget {
        @Override
