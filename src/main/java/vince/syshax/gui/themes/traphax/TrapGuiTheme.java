...
import  vince.syshax.gui.themes.traphax.widgets.*;
import vince.syshax.gui.themes.traphax.widgets.input.WMeteorDropdown;
import vince.syshax.gui.themes.traphax.widgets.input.WMeteorSlider;
import vince.syshax.gui.themes.traphax.widgets.input.WMeteorTextBox;
import  vince.syshax.gui.themes.traphax.widgets.pressable.*;
...
public class TrapGuiTheme extends GuiTheme {
    ...
    public final Setting<SettingColor> accentColor = color("accent", "Main color of the GUI.", new SettingColor(255, 147, 217));
    public final Setting<SettingColor> checkboxColor = color("checkbox", "Color of checkbox.", new SettingColor(255, 175, 226));
    public final Setting<SettingColor> plusColor = color("plus", "Color of plus button.", new SettingColor(255, 163, 255));
    public final Setting<SettingColor> minusColor = color("minus", "Color of minus button.", new SettingColor(255, 1, 178));
    public final Setting<SettingColor> favoriteColor = color("favorite", "Color of checked favorite button.", new SettingColor(166, 116, 192));
