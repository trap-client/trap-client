...
public class WMeteorDropdown<T> extends WDropdown<T> implements TrapHaxWidget {
    ...
    private static class WRoot extends WDropdownRoot implements TrapHaxWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            TrapGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements TrapHaxWidget {
        @Override
