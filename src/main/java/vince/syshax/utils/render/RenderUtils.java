...
public class RenderUtils {
    ...
    public static void drawItem(ItemStack itemStack, int x, int y, double scale, boolean overlay) {
        ...
        SYSHax.mc.getItemRenderer().renderGuiItemIcon(itemStack, (int) (x / scale), (int) (y / scale));
        if (overlay) SYSHax.mc.getItemRenderer().renderGuiItemOverlay(SYSHax.mc.textRenderer, itemStack, (int) (x / scale), (int) (y / scale), null);
