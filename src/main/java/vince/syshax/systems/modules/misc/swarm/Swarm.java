...
package vince.syshax.systems.modules.misc.swarm;
...
public class Swarm extends Module {
    ...
    public Swarm() {
        super(Categories.Misc, "Swarm", "Allows you to control multiple instances of TrapClient from one central host.");
    }
