...
import vince.syshax.renderer.Framebuffer;
...
public class Blur extends Module {
    ...
    public Blur() {
        ...
        SYSHax.EVENT_BUS.subscribe(new ConsumerListener<>(WindowResizedEvent.class, event -> {
            if (fbo1 != null) {
                fbo1.resize();
                fbo2.resize();
            }
        ...
        SYSHax.EVENT_BUS.subscribe(new ConsumerListener<>(RenderAfterWorldEvent.class, event -> onRenderAfterWorld()));
    }
