...
package vince.syshax.systems.modules.movement.elytrafly;
...
import vince.syshax.systems.modules.movement.elytrafly.modes.Packet;
import vince.syshax.systems.modules.movement.elytrafly.modes.Pitch40;
import vince.syshax.systems.modules.movement.elytrafly.modes.Vanilla;
import vince.syshax.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        SYSHax.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        SYSHax.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        SYSHax.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        SYSHax.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
