...
import vince.syshax.systems.modules.render.WaypointsModule;
...
public class Waypoints extends System<Waypoints> implements Iterable<Waypoint> {
    ...
    @Override
    public void init() {
        File iconsFolder = new File(new File(SYSHax.FOLDER, "waypoints"), "icons");
        iconsFolder.mkdirs();
    ...
    public File getFile() {
        ...
        return new File(new File(SYSHax.FOLDER, "waypoints"), Utils.getWorldName() + ".nbt");
    }
    ...
    private void copyIcon(File file) {
        StreamUtils.copy(Waypoints.class.getResourceAsStream("/assets/" + SYSHax.MOD_ID + "/textures/icons/waypoints/" + file.getName()), file);
    }
